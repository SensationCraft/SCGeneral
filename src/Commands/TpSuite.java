...
public class TpSuite implements CommandExecutor
{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)
    {
        ...
        TpRequest req = this.requests.get(player.getName());
    ...
    public void request(String requester, String requested, boolean isHere)
    {
        this.requests.put(requested, new TpRequest(requester, requested, isHere));
    }
    
    public void clear(String requested)
    {
    ...
    protected class TpRequest
    {
        ...
        public TpRequest(String requester, String requested, boolean isHere)
        {
